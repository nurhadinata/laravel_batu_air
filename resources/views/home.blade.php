    ...
    <table class="table table-striped">
        <thead>
            <tr>
                ...
                <th scope="col" class="text-center">Nama Sungai</th>
        ...
        <tbody>
            ...
            @foreach ($sampling_time as $value)
                @if(sizeof($value->quality)>0)
                <th scope="row" class="text-center">{{$counter++}}</th>
                <td class="text-center">Sungai Brantas</td>
                <td class="text-center">{{explode('-',$value->time)[0]}}</td>
                <td class="text-center">{{$value->quarter}}</td>
                <td class="inline-block text-center">
                    <a href="{{ route('admin.show', $value->id) }}"><button class="btn bg-success"><i class="fa fa-eye"></i></button></a>
                    <button class="btn btn-danger" data-toggle="modal" id="smallButton" data-target="#smallModal" data-attr="{{ route('admin.deleteSampling', $value->id) }}" title="Delete Project">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-header">Masukkan Data Kualitas</h5>
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group row">
                        ...
                        <select class="custom-select col-sm-6" id="monitoring_point_id" name="monitoring_point_id">
                ...
                <div class="col">
                    <div class="form-group row">
                        ...
                        <select class="custom-select my-1 col-sm-6" id="sampling_time_id" name="sampling_time_id" onchange="sampling_handler()">
                            <option selected>Choose...</option>>
